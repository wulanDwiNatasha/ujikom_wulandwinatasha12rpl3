                ...
                <div class="card">
                  ...
                  ?>
                        <form action="login.php" method="post">
                            ...
                            <input type="submit" value="Login" class="btn btn-info my-3" name="submit">
                            <p>Belum Punya Akun? <a href="daftar.php" class="link-info">Daftar Sekarang</a></p>
                        </form>
                    </div>
                </div>
            </div>
