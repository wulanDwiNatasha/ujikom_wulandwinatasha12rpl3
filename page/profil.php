                ...
                <div class="card-body">
                    ...
                    <?php echo @$alert; if (@$_GET['proses'] == 'editprofile') : ?>
                        <form action="?url=profile&&proses=editprofile" method="post">
                            ...
                            <input type="submit" value="Simpan Perubahan" name="editprofile" onclick="return confirm('Apakah anda yakin Merubah Profil ini?')" class="btn btn-primary fw-semibold">
                        </form>
